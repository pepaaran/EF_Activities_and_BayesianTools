...
library(BayesianTools) # this is used in the GECO lab
```
...
"
```
-Pepa- Here I define the likelihood necessary to fit a BayesianTools model. 
```{r}
# Define the log likelihood for the random walk process, data process and priors. Must include the hidden state as parameters
likelihood <- function(param){
  # param[1] = tau_obs,  param[2] = tau_add, param[3:622] = x[t]
  
  param[3] <- dnorm
  xt <- param[1] + param[4:13]
